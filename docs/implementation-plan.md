...
*For automation sequencing, refer to [`automation-roadmap.md`](./automation-roadmap.md).*  
*For architecture and control integration, refer to [`mes-integration.md`](./mes-integration.md).*  
*For environmental and statutory obligations, refer to [`regulatory.md`](./regulatory.md).*  
*For supply commitments and sourcing posture, refer to [`supply-chain.md`](./supply-chain.md).*  
*For AI/DT posture and closure status, refer to [`ai-platform-status.md`](./ai-platform-status.md) and [`gap-closure-report.md`](./gap-closure-report.md).*
