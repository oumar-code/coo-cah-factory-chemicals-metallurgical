<!-- All links to other docs files use relative paths without docs/ prefix (e.g. regulatory.md) -->
...
| --- | --- | --- |
| ISO 9001:2015 — Quality Management | `docs/standards/iso-requirements.md` | `regulatory.md` |
| ISO 14001:2015 — Environmental | `docs/standards/iso-requirements.md` | `regulatory.md` |
| ISO 45001:2018 — Health &amp; Safety | `docs/standards/iso-requirements.md` | `regulatory.md` |
| ISO 50001:2018 — Energy | `docs/standards/iso-requirements.md` | `energy-profile.md` |
| Automation Phases Framework | `docs/standards/automation-phases.md` | `automation-roadmap.md` |
| Supply Chain Doctrine | `docs/standards/supply-chain-doctrine.md` | `supply-chain.md` |
| Energy Strategy | `docs/standards/energy-strategy.md` | `energy-profile.md` |
| AI Platform Standards | `docs/standards/ai-platform.md` | `digital-twin.md`, `automation-roadmap.md` |
| MES Integration Standards | `docs/standards/mes-integration-standards.md` | `mes-integration.md` |
...
4. **Cross-Factory Dependencies:** All intra-group supply relationships documented in `supply-chain.md` are mirrored in the master repo's `orchestration/supply-chain-map.md`.
